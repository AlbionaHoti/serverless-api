    ...
    it("should throw a validation error if title is invalid", async () => {
        ...
        let [body] = await invoke({
            body: {
                query: CREATE_HABIT,
                variables: {
                    data: { description: "This is my 1st habit.", habitScore: 1 }
                }
            }
        });
        ...
        expect(error.message).toBe(
            'Variable "$data" got invalid value { description: "This is my 1st habit.", habitScore: 1 }; Field title of required type String! was not provided.'
        );
        ...
        [body] = await invoke({
            body: {
                query: CREATE_HABIT,
                variables: {
                    data: { title: "Aa", description: "This is my 1st habit.", habitScore: 1 }
                }
            }
        });
